...
###              'multilayer_vesicle': default_dict}
   targets = {'mass_fractal': random_mass_fractal,
              'surface_fractal': random_surf_frac,
              'teubner_strey': random_teubner,
              'multilayer_vesicle': random_MLS}
   default = {'mass_fractal': default_dict,
              'surface_fractal': default_dict,
              'teubner_strey': cs_sphere_default_dict,
              'multilayer_vesicle': default_dict}
